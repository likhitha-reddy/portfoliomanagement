...
const Firstpage = () => {
  ...
  const startTimer = () => {
    const countdownDate1 = new Date("Mar 8, 2023 15:00:00 GMT+0530").getTime();
    const countdownDate2 = new Date("Mar 8, 2023 15:02:00 GMT+0530").getTime();
    const countdownDate3 = new Date("Mar 8, 2023 15:04:00 GMT+0530").getTime();
    const countdownDate4 = new Date("Mar 8, 2023 15:06:00 GMT+0530").getTime();
    const countdownDate5 = new Date("Mar 8, 2023 15:08:00 GMT+0530").getTime();
