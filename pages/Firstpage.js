...
const Firstpage = () => {
  ...
  const startTimer = () => {
    const countdownDate1 = new Date('Mar 7, 2023 20:00:00 GMT+0530').getTime()
    const countdownDate2 = new Date('Mar 7, 2023 20:02:00 GMT+0530').getTime()
    const countdownDate3 = new Date('Mar 7, 2023 20:04:00 GMT+0530').getTime()
    const countdownDate4 = new Date('Mar 7, 2023 20:06:00 GMT+0530').getTime()
    const countdownDate5 = new Date('Mar 7, 2023 20:08:00 GMT+0530').getTime()
