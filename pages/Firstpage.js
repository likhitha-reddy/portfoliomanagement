...
const Firstpage = () => {
  ...
  const startTimer = () => {
    const countdownDate1 = new Date("Mar 7, 2023 14:20:00 GMT+0530").getTime();
    const countdownDate2 = new Date("Mar 7, 2023 14:25:00 GMT+0530").getTime();
    const countdownDate3 = new Date("Mar 7, 2023 14:30:00 GMT+0530").getTime();
    const countdownDate4 = new Date("Mar 7, 2023 14:35:00 GMT+0530").getTime();
    const countdownDate5 = new Date("Mar 7, 2023 14:40:00 GMT+0530").getTime();
