...
const Firstpage = () => {
  ...
  const startTimer = () => {
    const countdownDate1 = new Date('Mar 7, 2023 20:45:00 GMT+0530').getTime()
    const countdownDate2 = new Date('Mar 7, 2023 20:47:00 GMT+0530').getTime()
    const countdownDate3 = new Date('Mar 7, 2023 20:49:00 GMT+0530').getTime()
    const countdownDate4 = new Date('Mar 7, 2023 20:51:00 GMT+0530').getTime()
    const countdownDate5 = new Date('Mar 7, 2023 20:53:00 GMT+0530').getTime()
