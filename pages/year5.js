      ...
      <div className="container mx-auto min-h-screen flex flex-col justify-center max-w-xl items-center">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-row justify-center gap-3">
            ...
            <br/>
              last year the growth rate of this asset was {data[3].A}%
              </p>
              <input
                type="text"
                placeholder="Value"
            ...
            <div className="flex flex-col bg-white items-center font-bold text-lg px-4 py-8 rounded-lg shadow-md gap-3">
              ...
              <p className="font-light text-sm text-center">
                ...
                governmental.
                <br/>
              last year the growth rate of this asset was {data[3].B}
              </p>
              <input
                type="text"
                placeholder="Value"
          ...
          <div className="flex flex-row justify-center gap-3">
            <div className="flex flex-col bg-white items-center font-bold text-lg px-4 py-8 rounded-lg shadow-md gap-3">
              ...
              <p className="font-light text-sm text-center">
                ...
                <br/>
              last year the growth rate of this asset was {data[3].C}
              </p>
              <input
                type="text"
                placeholder="Value"
            ...
            <div className="flex flex-col bg-white items-center font-bold text-lg px-4 py-8 rounded-lg shadow-md gap-3">
              ...
              <p className="font-light text-sm text-center">
                ...
                or services.
                <br/>
              last year the growth rate of this asset was {data[3].D}
              </p>
              <input
                type="text"
                placeholder="Value"
